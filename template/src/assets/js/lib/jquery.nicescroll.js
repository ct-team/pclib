...
*/
        ...
        this.onResize = function(e, page) {
            ...
            // edit by ql
            self.cursorheight = self.opt.ctCursorHeight;  // 直接为传递的滚动条的高度
            self.scrollvaluemax = self.view.h - self.opt.ctCursorHeight; // 区域高度-滚动条的高度
            //console.log(self.cursorheight, self.cursorwidth,self.scrollvaluemax, self.railh.height);  console.log(self);
